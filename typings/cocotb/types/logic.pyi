...
class Logic:
    r"""Model of a 4-value (``0``, ``1``, ``X``, ``Z``) datatype commonly seen in HDLs.
    ...
    def __new__(
        ...
        value: typing.Optional[LogicConstructibleT] = ...,
    ) -> LogicT: ...
...
class Bit(Logic):
    r"""Model of a 2-value (``0``, ``1``) datatype commonly seen in HDLs.
